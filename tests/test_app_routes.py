...
class AppRouteTests(unittest.TestCase):
    ...
    def test_logged_in_dashboard_shows_empty_spending_profile_before_any_upload(self):
        ...
        self.assertIn("+$84/mo", page)
        self.assertIn("+$185/mo", page)
    ...
    def test_profile_payload_includes_pending_receipt_reviews(self):
        self._signup_and_login()
        storage = self.app.config["storage"]
        receipt_upload_id = storage.create_receipt_upload(1, "trader-joes.jpg", "uploads/trader-joes.jpg")
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b"Trader Joe&#39;s", response.data)

    def test_approved_receipt_behavior_note_can_appear_in_top_three_insights(self):
        self._signup_and_login()
        self.client.post(
            "/api/profile",
            json={
...
"""
    ...
    def test_logged_in_dashboard_renders_structured_goal_fields_and_new_dashboard_sections(self):
        ...
        self.assertIn(b'class="scenario-header"', response.data)
        self.assertIn(b'class="scenario-title"', response.data)
        self.assertIn(b'class="scenario-savings"', response.data)
        self.assertIn(b'+$48/mo', response.data)
        self.assertIn(b'+$78/mo', response.data)
...
"""
    ...
    def test_logged_in_dashboard_shows_income_and_leftover_money_sections(self):
        ...
        self.assertIn(b"decisions-toggle", response.data)
